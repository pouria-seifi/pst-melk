...
export default function SecondPocket() {
  return (
    <section className="flex flex-col-reverse px-4 justify-center lg:flex-row mt-14 md:px-40 items-center pt-12 md:pt-24 bg-circle bg-no-repeat bg-[position:100%_60%] lg:bg-[position:82%_20%] bg-250">
